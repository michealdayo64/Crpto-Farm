...
function PaymentForm() {
  const [order, setOrder] = useState(cartData);
  return (
    <>
          ...
          <div class="col-md-8">
            <div class="product-details mr-2">
              ...
              <div class="d-flex justify-content-between">
                <span>You have {order.length} items in your cart</span>
                <div class="d-flex flex-row align-items-center">
                ...
                order.map((ord) => {
                  return (
                    <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                      <div class="d-flex flex-row" key={ord.id}>
                        <img class="rounded" src={ord.img} width="40" alt="" />
                        <div class="ml-2">
                          <span class="font-weight-bold d-block">
                            {ord.title}
                          </span>
                          <span class="spec">Category: {ord.category}</span>
                        </div>
                      </div>
                      <div class="d-flex flex-row align-items-center">
                        <span class="d-block">{ord.quantity}</span>
